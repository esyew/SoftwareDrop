...
void showNumbers() {
    ...
    for (int w = 0; w < sets; w++) {
        std::vector<int> nums = (new randomGen()) -> getNumbers();
        ...
        std::cout << (new randomGen()) -> randomNum(26); //Print out powerball number
        std::cout << "\n";
    }
...
int main() {
    ...
    bool contin = askForMore(); //Ask user whether to get more numbers
...
//Testing
/*
std::vector<int> randomNums = getNumbers();
int Tests = randomNums.at(3);
int powerballTest = setPowerBall();
