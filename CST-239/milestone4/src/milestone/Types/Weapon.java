...
public class Weapon extends Product{
	...
	public Weapon(int itemID, int itemQuantity, String itemName, String itemCategory, String itemDescription, double itemPrice, String rarity, String type, int damage) {
